...
def normalize_path_option(option_value, separator=','):
    ...
    :py:ref:`normalize_multistring_option` for more details.
    """
...
def render_template(tmpl, logger=None, **kwargs):
    ...
    try:
        ...
        raise GlueError('Unhandled template type {}'.format(type(tmpl)))

    except Exception as exc:
        raise GlueError('Cannot render template: {}'.format(str(exc)))
