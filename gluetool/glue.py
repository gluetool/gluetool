...
class Glue(Configurable):
    ...
    def run_modules(self, pipeline_description, register=False):
        """
    ...
    def run_module(self, module_name, module_argv, register=False):
        """
        ...
        return self.run_modules([(module_name, module_argv)], register=register)
